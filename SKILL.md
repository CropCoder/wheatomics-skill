...
- `GET /api/id-conversion?ID=&gene_version=` — Convert gene IDs between IWGSC versions. Input: transcript IDs with `.1` suffix. Source DBs: `MIPS_result` (MIPSv2.2, e.g. `Traes_1AS_E6058767A.1`), `TGACv1_result` (TGACv1, e.g. `TRIAE_CS42_6BL_TGACv1_501926_AA1621570.1`), `IWGSCv1_result` (IWGSCv1.0, e.g. `TraesCS6B01G342500.1`) — all convert to IWGSC v1.1 (02G) format.
